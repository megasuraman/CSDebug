...
/**
 * @file CSDebug_ShortcutCommand.h
...
#include "CSDebug_ShortcutCommand.generated.h"
 ...
 */
UCLASS()
class CSDEBUG_API UCSDebug_ShortcutCommand : public UObject
{
	GENERATED_BODY()

	UCSDebug_ShortcutCommand();
