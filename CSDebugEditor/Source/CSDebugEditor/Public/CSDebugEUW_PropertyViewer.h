...
/**
 * @file CSDebugEUW_PropertyViewer.h
...
#include "CSDebugEUW_PropertyViewer.generated.h"
...
UCLASS()
class CSDEBUGEDITOR_API UCSDebugEUW_PropertyViewer : public UEditorUtilityWidget
{
	GENERATED_BODY()

public:
	UCSDebugEUW_PropertyViewer(const FObjectInitializer& ObjectInitializer);
