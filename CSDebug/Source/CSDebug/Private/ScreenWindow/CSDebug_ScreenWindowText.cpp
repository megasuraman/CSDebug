...
/**
 * @file CSDebug_ScreenWindowText.cpp
...
#include "CanvasItem.h"
  ...
  */
void	FCSDebug_ScreenWindowText::FittingWindowExtent(class UCanvas* InCanvas)
{
 ...
 * @brief 表示文字列追加
 */
void	FCSDebug_ScreenWindowText::AddText(const FString& InString)
{
 ...
 */
void	FCSDebug_ScreenWindowText::DrawAfterBackground(UCanvas* InCanvas, const FVector2D& InPos2D) const
{
