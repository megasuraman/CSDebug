...
#include "Misc/FileHelper.h"
  ...
  * @brief
  */
void	UCSDebugEUW_DTUID::GenerateDataTableUID(const UDataTable* InDataTable)
{
 ...
 * @brief
 */
bool UCSDebugEUW_DTUID::GetExistDTUID(TArray<FDTUIDInfo>& OutDTUIDList, const FString& InPath) const
{
	FString FileString;
 ...
 * @brief
 */
void UCSDebugEUW_DTUID::CheckDataTableRow(TArray<FDTUIDInfo>& OutDTUIDList, const UDataTable* InDataTable) const
{
 ...
 * @brief
 */
bool UCSDebugEUW_DTUID::CreateStringRelacepMap(TMap<FString, FString>& OutStringReplaceMap, const TArray<FDTUIDInfo>& InDTUIDList, const FString& InDataTableName) const
{
 ...
 * @brief
 */
bool UCSDebugEUW_DTUID::GetNewFileString(FString& OutFileString, const FString& InBaseFilePath, const TMap<FString, FString>& InStringReplaceMap)
{
