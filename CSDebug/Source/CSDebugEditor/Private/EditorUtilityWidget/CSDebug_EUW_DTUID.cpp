...
#include "EditorUtilityWidget/CSDebug_EUW_DTUID.h"
...
#include "Misc/FileHelper.h"
  ...
  * @brief
  */
void	UCSDebug_EUW_DTUID::GenerateDataTableUID(const UDataTable* InDataTable)
{
 ...
 * @brief
 */
bool UCSDebug_EUW_DTUID::GetExistDTUID(TArray<FDTUIDInfo>& OutDTUIDList, const FString& InPath) const
{
	FString FileString;
 ...
 * @brief
 */
void UCSDebug_EUW_DTUID::CheckDataTableRow(TArray<FDTUIDInfo>& OutDTUIDList, const UDataTable* InDataTable) const
{
 ...
 * @brief
 */
bool UCSDebug_EUW_DTUID::CreateStringRelacepMap(TMap<FString, FString>& OutStringReplaceMap, const TArray<FDTUIDInfo>& InDTUIDList, const FString& InDataTableName) const
{
 ...
 * @brief
 */
bool UCSDebug_EUW_DTUID::GetNewFileString(FString& OutFileString, const FString& InBaseFilePath, const TMap<FString, FString>& InStringReplaceMap)
{
