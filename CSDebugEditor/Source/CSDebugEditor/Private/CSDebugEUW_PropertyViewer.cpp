...
/**
 * @file UCSDebugEUW_PropertyViewer.cpp
 * @brief UObjectのProperty値表示
 * @author SensyuGames
 * @date 2022/08/07
 */
#include "CSDebugEUW_PropertyViewer.h"
...
UCSDebugEUW_PropertyViewer::UCSDebugEUW_PropertyViewer(const FObjectInitializer& ObjectInitializer)
...
/* ------------------------------------------------------------
   !プロパティの変化時
------------------------------------------------------------ */
void UCSDebugEUW_PropertyViewer::PostEditChangeProperty(FPropertyChangedEvent & PropertyChangedEvent)
{
...
/* ------------------------------------------------------------
   !World取得
------------------------------------------------------------ */
UWorld*	UCSDebugEUW_PropertyViewer::GetActiveWorld() const
{
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
FString	UCSDebugEUW_PropertyViewer::GetPropertyInfo(UObject* InTarget, UClass* InTargetClass)
{
	...
	const FName OriginalFuncName(TEXT("CSDebug_GetInfoPropertyViewer"));
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
bool	UCSDebugEUW_PropertyViewer::UpdatePropertyInfo(UObject* InTarget, UClass* InTargetClass)
{
	mPropertyInfo.Empty();
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
bool	UCSDebugEUW_PropertyViewer::SetupTargetObjectList()
{
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
FString	UCSDebugEUW_PropertyViewer::GetDispObjectName(UObject* InTarget) const
{
	if (InTarget)
	{
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
void	UCSDebugEUW_PropertyViewer::SetUpdateRealTime(bool bInRealTime)
{
	if (bInRealTime)
	{
		if (!mDrawDelegateHandle.IsValid())
		{
			FDebugDrawDelegate DrawDebugDelegate = FDebugDrawDelegate::CreateUObject(this, &UCSDebugEUW_PropertyViewer::Draw);
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
void	UCSDebugEUW_PropertyViewer::Clear()
{
...
/* ------------------------------------------------------------
   !Widget閉じたとき？
------------------------------------------------------------ */
void	UCSDebugEUW_PropertyViewer::NativeDestruct()
{
...
/* ------------------------------------------------------------
   !デバッグ表示
------------------------------------------------------------ */
void	UCSDebugEUW_PropertyViewer::Draw(UCanvas* InCanvas, APlayerController* InPlayerController)
{
	UpdateRealTime();
}
...
------------------------------------------------------------ */
bool UCSDebugEUW_PropertyViewer::FindDebuggingData(UBlueprint* Blueprint, UObject* ActiveObject, FProperty* InProperty, void*& OutData)
{
...
FString UCSDebugEUW_PropertyViewer::GetDebugInfo_InContainer(int32 Index, FProperty* Property, const void* Data)
{
	return GetDebugInfoInternal(Property, Property->ContainerPtrToValuePtr<void>(Data, Index));
}
FString UCSDebugEUW_PropertyViewer::GetDebugInfoInternal(FProperty* Property, const void* PropertyValue)
{
...
/* ------------------------------------------------------------
   !
------------------------------------------------------------ */
UWorld* UCSDebugEUW_PropertyViewer::FindWorld(const EWorldType::Type InType, const bool bInDGS) const
{
