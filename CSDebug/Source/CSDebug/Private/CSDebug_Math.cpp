...
#include "DrawDebugHelpers.h"
  ...
  */
float UCSDebug_Math::CalcSimpleEaseInOut(float InRatio)
{
 ...
 */
FVector UCSDebug_Math::CalcQuadraticBezier(const FVector& InPosA, const FVector& InPosB, const FVector& InPosC, float InRatio)
{
...
void UCSDebug_Math::FCapsule::Draw(const UWorld* InWorld, const FColor InColor) const
{
	DrawDebugCapsule(InWorld, mPos, mHalfHeight, mRadius, mRot.Quaternion(), InColor);
}

void UCSDebug_Math::FTriangle::Draw(const UWorld* InWorld, const FColor InColor) const
{
...
------------------------------------------------------------ */
bool UCSDebug_Math::CapsuleCapsuleIntersection(const FCapsule& InBaseCapsule, const FCapsule& InTargetCapsule)
{
...
------------------------------------------------------------ */
bool UCSDebug_Math::CapsuleTriangleIntersection(const FCapsule& InCapsule, const FTriangle& InTriangle)
{
...
------------------------------------------------------------ */
bool UCSDebug_Math::CapsuleSweepCapsuleIntersection(
