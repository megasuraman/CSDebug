...
/**
 * @file UCSDebug_EUW_PropertyViewer.cpp
 * @brief UObjectのProperty値表示
 * @author SensyuGames
 * @date 2022/08/07
 */
#include "EditorUtilityWidget/CSDebug_EUW_PropertyViewer.h"
...
UCSDebug_EUW_PropertyViewer::UCSDebug_EUW_PropertyViewer(const FObjectInitializer& ObjectInitializer)
...
FString UCSDebug_EUW_PropertyViewer::GetDebugInfo_InContainer(int32 Index, FProperty* Property, const void* Data)
{
	return GetDebugInfoInternal(Property, Property->ContainerPtrToValuePtr<void>(Data, Index));
}
FString UCSDebug_EUW_PropertyViewer::GetDebugInfoInternal(FProperty* Property, const void* PropertyValue)
{
