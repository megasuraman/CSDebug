...
#include "CSDebug_Math.generated.h"
 ...
 */
UCLASS()
class CSDEBUG_API UCSDebug_Math : public UObject
{
	GENERATED_BODY()
	
public:
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "CSDebug_Math")
